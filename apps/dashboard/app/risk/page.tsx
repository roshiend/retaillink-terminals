...
export default function RiskPage() {
  ...
  return <main className="moduleShell"><section className="modulePage">
    ...
    <p className="moduleWarning">Risk rule management is active. Payment-intent enforcement is the next engine step; until that wiring is enabled, these rules should not be treated as production fraud controls.</p>
